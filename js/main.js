...
$(document).ready(function () {
    ...
    $(".nav-toggle").click(function(){
        $(".header .nav").slideToggle();    //vysunu se navbar
      })
    ...
    // fixed header, navbar se bude posouvat se stránkou
  ...
  $("a").on('click', function(event) {
    ...
    $(".lightbox-close").click(function(){
        $(".lightbox").removeClass("open"); //křížek
    })

    // close lightbox when clicked outside of img-box 
    $(".lightbox").click(function(event){
        if($(event.target).hasClass("lightbox")){
             $(this).removeClass("open"); //když kliknu vedle funguje jako křížek
        }
      })
})
